...
function main(EventN,EventStoryN) {
	...
	if(EventN == 0){
		...
		if(EventStoryN == '前情提要'){
			...
			rply.text = '前情提要-過去的回憶\
			\n\
			\跟GM對話以觀看劇情';

		}else if(EventStoryN == '1'||EventStoryN == '第一話'){

			rply.text = '第一話 無限沙漠(上)\
			\n\
			\n 對手:莎拉\
			\n 通關獎勵:(10d2)G金幣\
			\n 初次通關獎勵:奇蹟石x5\
			\n 故事:\
			\n 路卡等人意外的被神秘的詛咒困在無限沙漠之中。\
			\n 在找到離開的方法的過程，他們遇見了神祕的少女「莎拉」。';

		}else if(EventStoryN == '2'||EventStoryN == '第二話'){

			rply.text = '第二話 無限沙漠(下)\
			\n\
			\n 對手:琉璃\
			\n 通關獎勵:(10d3)G金幣\
			\n 初次通關獎勵:奇蹟石x5\
			...
			rply.text = '第三話 光暗議會(上)\
			\n\
			\n 對手:遊行者\
			\n 通關獎勵:(10d3)G金幣\
			\n 初次通關獎勵:奇蹟石x10\
			\n 故事:\
			\n 在核心都市「里恩斯」準備前往光神殿的路卡等人，無意間和在附近遊行的人起爭執\
			\n 他們突然對路卡義行人展開攻擊，得阻止他們！';

		}else if(EventStoryN == '4'||EventStoryN == '第四話'){

			rply.text = '第四話 光暗議會(下)\
			\n\
			\n 對手:\
			\n 通關獎勵:(10d4)G金幣\
			\n 初次通關獎勵:奇蹟石x10\
			...
			\n 初次通關獎勵:奇蹟石x10\
			\n 故事:\
			\n 瑟蕾娜意外地出現在路卡等人面前，帶領他們前往天冠山頂，似乎在山頂上有神奇的秘密？';
			...
			\n 初次通關獎勵:奇蹟石x10\
			\n 故事:\
			\n 亞雷斯塔透露出神殿有不為人知的地下室後，要求路卡等人前往地下室\
			\n 在地下室中，究竟有什麼東西？';

		}else if(EventStoryN == 'Sp'){

			rply.text = '最終話 光暗交會之刻\
			\n\
			\n 對手:奧賽羅爾\
			\n 初次通關獎勵:武器「光神之書(UR)」\
			\n 奧賽羅爾認定路卡就是預言中將摧毀他理想之人，所以決定要殺掉他。\
			\n 這一刻，將成為對世界影響深遠的一瞬間！？';

		}else if(EventStoryN == '關卡'){

			rply.text = '劇情活動-路卡與梅里歐斯的回憶(後篇)\
			\n\
			\n 故事:\
			\n     三年前，路卡在尋找找能實現任何願望的「黃金之泉」時，意外和「她」相遇。\
			\n\
			\n     那個時候，他並沒有想到，他會在尋找希望的同時，發現不為人知的秘密。\
			\n\
			\n\
			\n 關卡情報:\
			\n 前情提要(觀賞完後會贈送1顆奇蹟石)[向GM確認]\
			\n 第一話 無限沙漠(上)\
			\n 第二話 無限沙漠(下)\
			\n 第三話 光暗議會(上)\
			\n 第四話 光暗議會(下)\
